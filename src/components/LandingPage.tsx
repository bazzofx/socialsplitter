    ...
    <div className="min-h-screen bg-[#fafafa] text-[#171717] font-sans overflow-x-hidden">
      ...
      <div className="absolute top-6 right-6 z-50 flex gap-2">
        <button 
          ...
          className={`w-10 h-10 rounded-full flex items-center justify-center text-2xl shadow-sm border transition-all ${language === 'en' ? 'border-indigo-600 bg-white scale-110' : 'border-transparent bg-white/50 hover:bg-white'}`}
          title="English (UK)"
        >
          🇬🇧
        </button>
        <button 
          ...
          className={`w-10 h-10 rounded-full flex items-center justify-center text-2xl shadow-sm border transition-all ${language === 'pt' ? 'border-indigo-600 bg-white scale-110' : 'border-transparent bg-white/50 hover:bg-white'}`}
      ...
      <header className="relative px-6 py-12 lg:py-24 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8 z-10">
          ...
          <h1 className="text-6xl lg:text-8xl font-black tracking-tighter leading-[0.85] uppercase italic">
            {t('hero_title_1')} <br />
            {t('hero_title_2')} <br />
            <span className="text-indigo-600">{t('hero_title_3')}</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              <h2 className="text-5xl font-black uppercase italic tracking-tight leading-none">
                {t('how_it_works_title').split('.')[0]} <br /> <span className="text-indigo-600">{t('how_it_works_title').split('.')[1] || 'works.'}</span>
              </h2>
      ...
      <footer className="py-12 border-t border-gray-100 text-center text-gray-400 text-sm font-bold uppercase tracking-widest">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div>© 2026 {t('all_rights_reserved')}</div>
        </div>
      </footer>
    </div>
  );
